...
function attachEventListener(element, events, handler) {
...
function initStacks() {
    ...
    for (let el of $(".stack")) {
        ...
        attachEventListener(el, "mouseup", function () {
...
function initDragAndDrop() {
    ...
    attachEventListener(document, "touchend", function (event) {
        ...
        const element = (() => {
            ...
            const hasAnyClassCheck = () => {
                return acceptableSelectors.some((className) => el.classList.contains(className));
            };
        ...
        if (element) {
            if (element.classList.contains('foundations')) {
                onDrop(element);
            }
